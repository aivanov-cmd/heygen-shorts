...
class APIKeyMiddleware:
    ...
    # =================================================
    # RUN ONE SCHEDULED PUBLICATION
    #
    # POST /run-scheduled-publication/{id}/{platform}
    #
    # Example:
    # POST /run-scheduled-publication/21/youtube
    #
    # Header:
    # x-api-key: MCP_API_KEY
    # =================================================
    ...
    if path.startswith(
        ...
        # ---------------------------------------------
        # Atomically claim scheduled publication.
        #
        # scheduled -> requested
        #
        # This prevents two scheduler runs from
        # processing the same publication.
        # ---------------------------------------------
        ...
        # ---------------------------------------------
        # Call existing n8n publishing workflow
        # ---------------------------------------------
